tgt=$1
exp=en-$tgt.postln.wmt_pretrain.mustc_mt_pretrain.mustc_st+mt.cress_adaptive
fairseq-train data/mustc/en-$tgt --text-data data/mustc/en-$tgt/binary/ --tgt-lang $tgt \
  ...
  --restore-file checkpoints/en-$tgt.postln.wmt_pretrain.mustc_mt_pretrain.mustc_st+mt.cress/checkpoint20.pt